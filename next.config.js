...
// Disable Sentry in development to avoid rate limiting and reduce noise
// Re-enable in production by uncommenting the withSentryConfig wrapper
module.exports =
  process.env.NODE_ENV === 'production'
    ...
    : nextConfig; // Disable Sentry in development
