...
const CreativeCategory: React.FC<IProps> = ({ active, formDetails, setFormDetails, setStage }) => {
              ...
              onChange={(e) => {
                setFormDetails({
                  ...
                  creativeCategories: e.target.value
                    ...
                    : removeElement(formDetails.creativeCategories, formDetails.creativeCategories.findIndex(type.value)),
                });
              }}
              value={type.value}
            />
