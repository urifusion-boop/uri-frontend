import { BrandProfileData, BrandProfileService } from '@/api/BrandProfileService';
import { AvailablePage, SocialAccountService } from '@/api/SocialAccountService';
import CustomButton from '@/components/atoms/CustomButton';
import SeoHead from '@/components/atoms/SeoHead';
import useCustomTheme from '@/hooks/theme.hook';
import { useAuth } from '@/providers/AuthProvider';
import { Box, Checkbox, CircularProgress, Divider, Grid, LinearProgress, Typography } from '@mui/material';
...
export default function BrandSetupPage() {
  ...
  useEffect(() => {
    if (!router.isReady || checkingExisting) return;
    const { sessionToken, connected } = router.query;
    ...
    if (connected === 'pending' && typeof sessionToken === 'string' && sessionToken) {
      ...
      router.replace('/social-media/brand-setup', undefined, { shallow: true });
  ...
  }, [router.isReady, router.query, checkingExisting]);
  ...
  return (
    <>
      <SeoHead title="Brand Setup — Uri Creative" />
