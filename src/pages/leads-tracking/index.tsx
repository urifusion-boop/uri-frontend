...
const LeadsIndexPage = () => {
  ...
  return (
    <Box sx={{ backgroundColor: '#f9fafb', minHeight: '100vh', py: 4, justifyContent: 'center', alignItems: 'center' }}>
      <DashboardLayout excludeHeader={true} bgColor="#f9fafb">
        <Container maxWidth="lg" sx={{ backgroundColor: '#fff', maxHeight: '1000px', justifyContent: 'center', alignItems: 'center', pb: 4 }}>
