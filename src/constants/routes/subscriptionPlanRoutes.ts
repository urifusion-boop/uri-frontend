...
const rawSubscriptionPlanRoutes: Record<ISubscriptionPlanApi, string> = {
  ...
  getByFilters: "/subscriptionPlans/providerFilters",
};

export const subscriptionPlanRoutes = RouteHelper.createRoutes(
  URI_TRANSACTIONS_SVC_PATH,
  rawSubscriptionPlanRoutes
);
