...
import AddSummary from "../profile/AddSummary";
import { ClientProfileDto } from "@/models/dtos/ClientProfileDto";
import Text from "@/components/atoms/CustomText";
import useCustomTheme from "@/hooks/theme.hook";
import { TextHelper } from "@/helpers/TextHelper";
import AddWorkDetails from "../profile/AddWorkDetails";
...
const BusinessDetails = ({ clientProfile }: BusinessDetailsProps) => {
  ...
  const address = `${clientProfile?.businessLocation?.address}, ${
    clientProfile?.businessLocation?.city
  }, ${clientProfile?.businessLocation?.state}, ${TextHelper.capitalize(
