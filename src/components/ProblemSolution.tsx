...
const ProblemSolution = () => {
  const [activeSection, setActiveSection] = useState<'listen' | 'find'>('find');
  const findGroupRef = useRef<HTMLDivElement | null>(null);
  const listenGroupRef = useRef<HTMLDivElement | null>(null);
  const listenStartRef = useRef<HTMLDivElement | null>(null);
  ...
  useEffect(() => {
    const onScroll = () => {
      ...
      setActiveSection(top <= 0 ? 'listen' : 'find');
    };
    onScroll();
      ...
      <div className="container mx-auto px-4 sm:px-6">
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 max-w-6xl mx-auto">
          ...
          <div className="space-y-10">
            <div ref={findGroupRef} className="space-y-10">
            ...
            <div ref={listenStartRef} className="h-0" />
            ...
            <div ref={listenGroupRef} className="space-y-10">
              <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="relative">
                <div className="relative bg-card rounded-2xl p-8 border border-border shadow-strong">
