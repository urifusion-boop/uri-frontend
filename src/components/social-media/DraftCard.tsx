import { ApprovePayload, ContentDraft, DenyPayload, SocialMediaAgentService } from '@/api/SocialMediaAgentService';
...
const platformChip: Record<string, { icon: JSX.Element; color: string; bg: string }> = {
