...
const BusinessDetailsForm: React.FC<IProps> = ({ active, formDetails, setFormDetails, setStage }) => {
  const { onSubmit, BusinessDetailsSchema } = useClientProfileSetupHook();

  // const renderMode = (tab: Tab): "base" | "lightSecondary" => {
  //   return activeTab === tab ? "base" : "lightSecondary";
  // };
  // const renderColor = (tab: Tab) => {
  //   return activeTab === tab
  //     ? themeColors.blackWhite
  //     : themeColors.lightSecondary;
  // };
